...
object PageRank {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // 读取文件
    // 也可以是HDFS路径
    val fileRDD: RDD[String] = sc.textFile("C:\\Users\\Administrator\\Desktop\\Big-Data-Systems-and-Information-Processing\\3.PigHiveSpark\\data\\pagerank-data\\web-Google.txt").persist()
